...
Для использования функционала продажи разливного маркированного алкоголя необходимо произвести дополнительные настройки схемы РМК.

1.  В выражение проверки товара на алкоголь необходимо ввести текст, как на рисунке
![8e818d1491d063fec2baf327439b7689.png](/images/egais/working/8e818d1491d063fec2baf327439b7689.png){.align-center}

	```js
	RETURN ЗАПРОС( "SELECT dbo.fn_alcotype( nnvid ) FROM sprnn WHERE nn = '" + Товар + "'" );
	```
2.  С таким выражением марка будет запрашиваться при продаже любого маркированного алкоголя, что необходимо, в том числе, и для продажи алкоголя в розлив.

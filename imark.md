...
> Если требуется установить несколько экземпляров локального модуля на один компьютер, то для этого можно воспользоваться отдельной [инструкцией по развертыванию локального модуля в среде docker](/imark/lmdocker)
{.is-info}

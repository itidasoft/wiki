...
> Внимание! Работа с Модулем Регистрации Продаж версии 1 не поддерживается. Для работы с разрешительным режимом на кассе необходимо перейти на Айтида РМК (МРП 2).
{.is-warning}

...
> **Важно! Архив нужно распаковать в каталог на жестком диске и дальнейшие действия с файлами производить в распакованном каталоге. Запуск файла установки службы из архива может привести к ошибкам запуска службы iMark.**
{.is-danger}
...
- В карточках групп ресурсов (Справочники - Классификаторы - Группы ресурсов) выбрать фирму. 
	![gr_firm.png](/images/imark/gr_firm.png)
- В карточках товара выбрать соответствующие им группы ресурсов.
- GTIN из проверяемых кодов маркировок должны быть указаны в карточках товаров в поле GTIN (полностью с лидирующим нулем) или добавлены в штрихкоды (13 символов без лидирующего нуля).
	![goods_gtin.png](/images/imark/goods_gtin.png)

Со стороны iMark необходимо в каждой организации указать ИНН.
![imark_firm.png](/images/imark/imark_firm.png){.align-center}

При таких настройках в запросах проверки из Айтида РМК будет заполняться ИНН фирмы из группы ресурсов товара и iMark проверки будет производить по организации, у которой ИНН совпадает с ИНН из запроса. Если ИНН будет не указан в запросе на проверку КМ, то проверка КМ будет произведена по организации, помеченной в iMark как "Основная".

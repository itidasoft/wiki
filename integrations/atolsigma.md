...
> Интеграция доступна только с **Sigma Торговля**. Для **Sigma Еда** и **Sigma Услуги** отсутствует двухсторонний обмен данными и нет возможности передавать справочники по API.
{.is-info}

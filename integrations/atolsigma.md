...
Для выбранной группы ресурсов необходимо установить значение дополнительного свойства "СНО в АТОЛ Sigma". Как добавить дополнительный реквизит для групп ресурсов описано в разделе .

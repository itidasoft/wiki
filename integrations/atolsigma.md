...
1. Настроить константы для установки СНО поумолчанию для товаров и для услуг. (подробнее в разделе )
2. В свойствах папки необходимо выбрать группу ресурсов товара и добавить дополнительное свойство.

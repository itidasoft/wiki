...
>   Для отключения механизма печати ваучеров необходимо в настройках констант системы создать константу **_UDS_ПЕЧАТАТЬВАУЧЕРЫ** и установить для неё значение логического типа «Истина».
{.is-info}

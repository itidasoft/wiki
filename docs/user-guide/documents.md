...
1.  На вкладке «Дополнительные реквизиты» определяется срок действия калькуляции. В поле «в сезон» нужно выбрать в выпадающем списке один из зарегистрированных в системе сезонов (см. раздел [«Справочник сезонов»](#Сезоны)).

...
Справочник содержит список всех используемых программой сезонов. Сведения из этого справочника используются при определении срока действия документа [Калькуляции](#Калькуляции).

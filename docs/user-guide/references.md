...
| ![image7.png](/images/user-guide/references/image7.png) | Кнопка **«Удалить»** или клавиша <kbd>Del</kbd> - удаляет запись из списка (запись, на которой находится курсор, можно удалить нажатием клавиши Del). Для исключения случайного повреждения базы данных программа просит подтвердить удаление. |

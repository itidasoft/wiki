...
| ![image18.png](/images/user-guide/references/image18.png) | Кнопка с выпадающим списком **«Дополнительные возможности»** - выбор опции **«Работа со штрих-кодами»** или нажатие кнопки открывает окно [«Генерация и печать ШК»](/docs/user-guide/basic#ГенерацияИПечатьШК) |

...
Автоматически созданное описание](/images/user-guide/references/image47.png){width="5.97286198600175in" height="1.6621434820647418in"}
...
![2013-04-05_115226.png](/images/user-guide/references/image48.png){width="5.232283464566929in" height="4.299212598425197in"}
...
![2013-04-05_115236.png](/images/user-guide/references/image49.png){width="5.325893482064742in" height="4.375361986001749in"}

+-------+--------------------------------------------------------------+
| > !   | > Дополнительные свойства настраиваются в справочнике        |
| [Note | > **«Группы ресурсов»**. Описание свойств элементов          |
| 4](E: | > (название, тип, возможное значение и т.п.) хранится в      |
| \Alex | > справочнике понятий. Подробнее о группах можно узнать в    |
| Krut\ | > разделе [Справочник «Группы                                |
| OneDr | > ресурсов»](#справочник-группы-ресурсов).                   |
| ive\Р |                                                              |
| абоча |                                                              |
| я пап |                                                              |
| ка\!А |                                                              |
...
![](/images/user-guide/references/image50.png){width="4.441666666666666in" height="0.5972222222222222in"}
...
![2013-04-05_122732.png](/images/user-guide/references/image51.png){width="5.3339435695538056in" height="2.9532108486439195in"}

Необходимо создать одну или несколько характеристик в справочнике и заполнить обязательные реквизиты.

![2013-04-05_122822.png](/images/user-guide/references/image52.png){width="4.318897637795276in" height="2.409448818897638in"}
...
![2013-04-05_125025.png](/images/user-guide/references/image53.png){width="5.73829615048119in" height="2.9444608486439194in"}
...
![](/images/user-guide/references/image54.png){width="4.856944444444444in" height="4.0in"}
...
![2013-04-05_125405.png](/images/user-guide/references/image55.png){width="5.205932852143482in" height="3.2263385826771653in"}
...
+-------+--------------------------------------------------------------+
| > !   | > Для просмотра карточки подчиненного элемента, необходимо   |
| [Note | > выделить его в списке, и нажать кнопку с лупой             |
| 4](E: |                                                              |
| \Alex |                                                              |
| Krut\ |                                                              |
| OneDr |                                                              |
...
![Изображение выглядит как текст
Автоматически созданное описание](/images/user-guide/references/image57.png){width="4.169291338582677in" height="3.468503937007874in"}

+------+---------------------------------------------------------------+
| >    | > В карточке товара можно привязать только одну группу        |
|  ![N | > модификаторов.                                              |
| ote4 |                                                               |
| ](E: |                                                               |
| \Ale |                                                               |
...
Автоматически созданное описание](/images/user-guide/references/image58.png){width="4.169291338582677in" height="3.468503937007874in"}
...
![Изображение выглядит как стол
Автоматически созданное описание](/images/user-guide/references/image59.png){width="4.0256944444444445in" height="1.4548611111111112in"}
...
![](/images/user-guide/references/image60.png){width="5.441666666666666in" height="2.636111111111111in"}

2.  В справочнике **«Группы ресурсов»** необходимо создать группу и добавить в нее созданные характеристики для **«Бизнес-ланча»**.

![Изображение выглядит как текст
Автоматически созданное описание](/images/user-guide/references/image61.png){width="5.129861111111111in" height="2.49375in"}
...
![Изображение выглядит как текст
Автоматически созданное описание](/images/user-guide/references/image62.png){width="4.714583333333334in" height="3.870138888888889in"}
...
![Изображение выглядит как стол
Автоматически созданное описание](/images/user-guide/references/image63.png){width="5.311805555555556in" height="2.9868055555555557in"}
...
+-------+--------------------------------------------------------------+
| >     | ***Внимание!** Для подобранных блюд, должна быть составлена  |
|  ![At | **калькуляция**.*                                            |
| entio |                                                              |
| n4](E |                                                              |
| :\Ale |                                                              |
...
+-------+--------------------------------------------------------------+
| >     | ***Внимание!** Чтобы документ **«Выпуск и комплектация»**    |
|  ![At | был сформирован автоматически, в момент списания продаж      |
| entio | блюд, в карточках **«Комбинаций характеристик»** на закладке |
| n4](E | **«Цены и дополнительная информация»** необходимо установить |
| :\Ale | флаги **«Может быть собран»**, **«Собирать автоматически»**, |
| xKrut | **«Всегда»** или **«Если нет на складе»**, в зависимости от  |
| \OneD | принятого документооборота на предприятии.*                  |
| rive\ |                                                              |
| Рабоч |                                                              |
| ая па |                                                              |
| пка\! |                                                              |
...
![2013-04-05_112825.png](/images/user-guide/references/image64.png){width="5.3707764654418195in" height="1.9475656167979003in"}

##### Вкладка «Основные реквизиты»

![2013-04-05_112942.png](/images/user-guide/references/image65.png){width="5.485827865266842in" height="4.877271434820647in"}
...
+-------+--------------------------------------------------------------+
| >     | > *Для удобства дальнейшего использования сортировки,        |
| ![Not | > выбора, составления отчетов рекомендуется вводить название |
| e4](E | > без кавычек, без пробелов перед названием, а форму         |
| :\Ale | > собственности вводить через запятую после названия.*       |
| xKrut |                                                              |
| \OneD |                                                              |
| rive\ |                                                              |
| Рабоч |                                                              |
...
+-------+--------------------------------------------------------------+
| >     | ***Примечание!** Карточки контрагентов не будут видны в      |
| ![Not | справочнике **«Контрагенты»,** если в **«Параметрах          |
| e4](E | пользователя»** указать **«Не отображать неиспользуемые      |
| :\Ale | карточки»**.*                                                |
| xKrut |                                                              |
| \OneD |                                                              |
| rive\ |                                                              |
...
![2013-04-05_112957.png](/images/user-guide/references/image67.png){width="4.850393700787402in" height="4.311023622047244in"}
...
+-------+--------------------------------------------------------------+
| >     | ***Примечание!** Признак **«Розничным                        |
| ![Not | продавцом/покупателем»** используются для формирования       |
| e4](E | отчета **«Алкогольная декларация»**, а также для фильтра в   |
| :\Ale | приходных и расходных накладных при установленном флаге      |
| xKrut | **«Использовать типы контрагентов»** в настойках системы.*   |
| \OneD |                                                              |
| rive\ |                                                              |
| Рабоч |                                                              |
| ая па |                                                              |
...
![2013-04-05_113005.png](/images/user-guide/references/image68.png){width="4.8858267716535435in" height="4.34251968503937in"}
...
![2013-04-04_165129.png](/images/user-guide/references/image69.png){width="5.618110236220472in" height="2.251968503937008in"}

Данный справочник используется для определения мест хранения и учета ТМЦ.

![Изображение выглядит как текст
Автоматически созданное описание](/images/user-guide/references/image70.png){width="4.97244094488189in" height="2.574803149606299in"}
...
+-------+--------------------------------------------------------------+
| >     | **Внимание**! Поле **«КПП»** присутствует, начиная с версии  |
|  ![At | **ПП Айтида 2.99.35**                                        |
| entio |                                                              |
| n4](E |                                                              |
| :\Ale |                                                              |
| xKrut |                                                              |
...
+-------+--------------------------------------------------------------+
| >     | ***Внимание!** Использовать механизм отрицательных остатков  |
|  ![At | возможно при условии, что в конце цепочки отрицательный      |
| entio | остаток будет компенсирован.*                                |
| n4](E |                                                              |
| :\Ale |                                                              |
| xKrut |                                                              |
| \OneD |                                                              |
...
![Изображение выглядит как текст
Автоматически созданное описание](/images/user-guide/references/image71.png){width="3.970138888888889in" height="2.0597222222222222in"}
...
![2013-04-04_163622.png](/images/user-guide/references/image72.png){width="6.126346237970254in" height="2.769838145231846in"}
...
![2013-04-04_163655.png](/images/user-guide/references/image73.png){width="5.185715223097113in" height="5.020798337707786in"}
...
![2013-04-04_164409.png](/images/user-guide/references/image74.png){width="4.623917322834646in" height="4.4768667979002625in"}
...
![2013-04-04_164635.png](/images/user-guide/references/image75.png){width="3.7904308836395453in" height="3.6698862642169727in"}
...
![2013-04-04_164716.png](/images/user-guide/references/image76.png){width="3.9460334645669293in" height="3.820541338582677in"}
...
![Изображение выглядит как текст
Автоматически созданное описание](/images/user-guide/references/image77.png){width="3.5324682852143483in" height="1.3246751968503938in"}
...
Автоматически созданное описание](/images/user-guide/references/image78.png){width="4.102362204724409in" height="3.0039370078740157in"}
...
![Изображение выглядит как текст
Автоматически созданное описание](/images/user-guide/references/image79.png){width="5.2047244094488185in" height="4.0078740157480315in"}
...
![Изображение выглядит как текст
Автоматически созданное описание](/images/user-guide/references/image80.png){width="4.1948053368328955in" height="2.3171314523184603in"}
...
+-------+--------------------------------------------------------------+
| >     | **Внимание!** Применение норм естественной убыли возможно    |
|  ![At | только в том случае, если такие нормы утверждены             |
| entio | нормативными актами соответствующих министерств и ведомств.  |
| n4](E | Если такие нормы отсутствуют, вся недостача считается        |
| :\Ale | сверхнормативной и подлежит отнесению на виновных лиц в      |
| xKrut | полном размере.                                              |
| \OneD |                                                              |
| rive\ |                                                              |
| Рабоч |                                                              |
| ая па |                                                              |
...
![Изображение выглядит как текст
Автоматически созданное описание](/images/user-guide/references/image81.png){width="6.7047244094488185in" height="2.2598425196850394in"}
...
![](/images/user-guide/references/image82.png){width="3.831169072615923in" height="3.426248906386702in"}
...
+-------+--------------------------------------------------------------+
| >     | **Внимание!** Размер норм естественной убыли зависит от      |
|  ![At | климатической зоны, видов и групп товаров, времени года,     |
| entio | условий и срока хранения. Значение определенной зоны и       |
| n4](E | группы для каждого магазина устанавливаются в справочнике    |
| :\Ale | **«Константы системы»** администратором.                     |
| xKrut |                                                              |
| \OneD |                                                              |
| rive\ |                                                              |
| Рабоч |                                                              |
...
![C:\\Users\\k.fomicheva\\AppData\\Local\\Microsoft\\Windows\\Temporary Internet Files\\Content.Outlook\\E5HTBRH4\\рисунок1 (3).jpg](/images/user-guide/references/image83.jpeg){width="5.560416666666667in" height="4.628472222222222in"}
...
![Изображение выглядит как текст
Автоматически созданное описание](/images/user-guide/references/image84.png){width="5.244094488188976in" height="1.858267716535433in"}
...
+-------+--------------------------------------------------------------+
| >     | **Внимание!** Для учета товаров по срокам годности,          |
|  ![At | необходимо, в первую очередь, организовать учет продажи      |
| entio | товаров через кассу с указанием сроков годности и возврат    |
| n4](E | этой информации в систему Айтида. Без этого условия все      |
| :\Ale | остальные настройки не будет иметь эффекта.                  |
| xKrut |                                                              |
| \OneD |                                                              |
| rive\ |                                                              |
| Рабоч |                                                              |
...
+-------+--------------------------------------------------------------+
| >     | **Примечание! Норма естественной убыли** - это справочная    |
| ![Not | информация, которая необходима только для одной цели -       |
| e4](E | оценки того, насколько выявленная недостача превышает        |
| :\Ale | нормативы убыли.                                             |
| xKrut |                                                              |
| \OneD |                                                              |
| rive\ |                                                              |
...
![2013-04-04_162936.png](/images/user-guide/references/image85.png){width="4.8431452318460195in" height="2.99962489063867in"}
...
![2013-04-04_163012.png](/images/user-guide/references/image86.png){width="4.166146106736658in" height="2.3949103237095364in"}
...
![2013-04-04_162428.png](/images/user-guide/references/image87.png){width="4.738991688538933in" height="2.851178915135608in"}
...
![2013-04-04_162839.png](/images/user-guide/references/image88.png){width="4.208661417322834in" height="1.811023622047244in"}
...
![Изображение выглядит как текст
Автоматически созданное описание](/images/user-guide/references/image89.png){width="5.104166666666667in" height="2.298611111111111in"}
...
![Изображение выглядит как текст
Автоматически созданное описание](/images/user-guide/references/image90.png){width="3.9868055555555557in" height="1.3375in"}
...
![Изображение выглядит как текст
Автоматически созданное описание](/images/user-guide/references/image91.png){width="3.16875in" height="1.9222222222222223in"}
...
+-------+--------------------------------------------------------------+
| > ![E | ***Примечание!** Для анализа выручки в разрезе видов оплат   |
| xampl | предназначен отчет по видам оплат.*                          |
| e4](E |                                                              |
| :\Ale |                                                              |
| xKrut |                                                              |
| \OneD |                                                              |
...
![2013-04-04_163455.png](/images/user-guide/references/image92.png){width="4.078740157480315in" height="2.3661417322834644in"}

+-------+--------------------------------------------------------------+
| >     | ***Внимание!** Расчетный счет обязательно должен быть связан |
|  ![At | с денежным карманом. Используемые по умолчанию данные        |
| entio | юридическим лицом, расчетные счета указываются в справочнике |
| n4](E | **«Фирмы»**.*                                                |
| :\Ale |                                                              |
| xKrut |                                                              |
| \OneD |                                                              |
...
![2013-04-04_163516.png](/images/user-guide/references/image93.png){width="3.9291338582677167in" height="1.5433070866141732in"}
...
-   **Денежный карман** --- из выпадающего списка выбрать [денежный карман](mk:@MSITStore:c:\program%20files\itida\Doc\Itida_UserManual.chm::/spravochnikdenezhnyhkarmanov.htm), которому соответствует данный расчетный счет.
...
![Изображение выглядит как текст
Автоматически созданное описание](/images/user-guide/references/image94.png){width="3.97244094488189in" height="3.374015748031496in"}
...
-   **В табличной части «Курс на дату» ---** перечисляются зарегистрированные виды валют с указанием курса пересчёта.
  ...
  --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ![Example4](/images/user-guide/references/image30.png){width="0.44166666666666665in" height="0.7534722222222222in"}   **Примечание!** В случае регистрации в системе нескольких валют, на вкладке **«Прочее»** окна **«Базовые параметры системы»** в секторе **«Валюта учёта»** можно выбрать, какая из них будет основной валютой, а какая будет дополнительной.
  --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
![Карточка Типа оговора.PNG](/images/user-guide/references/image95.png){width="5.153543307086614in" height="4.366141732283465in"}
...
![Карточка Типа оговора2.PNG](/images/user-guide/references/image96.png){width="5.133858267716535in" height="4.338582677165355in"}
...
![Карточка Договора.PNG](/images/user-guide/references/image97.png){width="5.988188976377953in" height="3.661417322834646in"}
...
-   **В секторе «Реквизиты контрагента» ---** находятся поле для выбора контрагента из справочника, вызываемого одноимённой кнопкой, или вместо имени контрагента можно выбрать адрес доставки с помощью кнопки, находящейся ещё правее предыдущей. Откроется окно «Адреса клиентов», выделив в котором строку с нужной записью, следует нажать кнопку «Выбрать».
  ...
  ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ![Note4](/images/user-guide/references/image25.png){width="0.44166666666666665in" height="0.7534722222222222in"}   Остальные поля заполняются только в том случае, когда их содержание должно отличаться от содержания аналогичных полей в карточке контрагента.
  ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ -----------------------------------------------------------------------------------------------------------------------------------------------
...
![Карточка Договора2.PNG](/images/user-guide/references/image98.png){width="5.509863298337708in" height="3.352886045494313in"}
...
![Карточка Налоги.PNG](/images/user-guide/references/image99.png){width="3.322834645669291in" height="2.7283464566929134in"}
...
![Карточка Налога.PNG](/images/user-guide/references/image100.png){width="3.9645669291338583in" height="1.5236220472440944in"}

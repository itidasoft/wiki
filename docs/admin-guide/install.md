...
> Внимание! Программные продукты Айтида версии 4, Айтида РМК, Айтида iMark не поддерживают работу с Windows XP (подробный список совместимости смотри в таблице ниже).
{.is-warning}

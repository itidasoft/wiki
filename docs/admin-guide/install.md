...
> Внимание! Программные продукты Айтида версии 4, Айтида РМК, Айтида iMark не поддерживают работу с Windows XP (подробнее о совместимости смотри в таблице ниже).
{.is-warning}

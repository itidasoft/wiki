...
> **Внимание!** *По умолчанию используется экспорт* **«Выгрузка в бухгалтерию v.2».**
{.is-warning}
...
Настроить формат выгружаемого файла можно в **«Карточке описания экспорта данных»**. Подробнее о настройке карточки описания экспорта и импорта можно узнать в разделе [Настройка импорта/экспорта данных](/docs/admin-guide/impexp).

...
| ![Note4](/images/admin-guide/documents/fc00805c71ddc6ddc2e161712dbd6066.png) | Примечание! Параметры ТТК могут быть изменены или настроены под конкретную задачу администратором системы в «Справочнике параметров», который доступен только с NFR ключом в конфигурации «Конфигурирование» (меню Сервис - Настройка системы).  |
|------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![Note4](/images/admin-guide/documents/fc00805c71ddc6ddc2e161712dbd6066.png) | Примечание! Система Айтида хранит историю изменения калькуляционных карт. Можно заранее спланировать изменение в составе блюда или продукта с учетом периода, сезона.  |
|------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![Atention4](/images/admin-guide/documents/ecbb6d6100a6b04c1847c718353795f8.png) | Внимание! Для ручной замены основного ингредиента на его аналог необходимо в документе «Выпуск и комплектация» вызвать окно «Ввод комплектации», выделить основной ингредиент и выбрать необходимую замену из предлагаемого списка.  |
|----------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![Atention4](/images/admin-guide/documents/ecbb6d6100a6b04c1847c718353795f8.png) | Внимание! Процесс формирования приходных накладных, в случае получения данных из ЕГАИС, описан в [Айтида модуль ЕГАИС](http://itida.ru/download/docs/itida_egais201701.pdf).  |
|----------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
1.  После подтверждения выбора, происходит возврат в документ, в котором добавляются новые колонки с ценами.

![](/images/admin-guide/documents/adc27f7dfcc95cc02d1b8a3e59628351.png)

1.  Поле документа **«Категория цены»** теперь означает текущую переоцениваемую категорию. Это значит, что расчет остатка, расчет закупочной цены и сам процесс наценки будет производиться относительно складов и цены связанных с выбранной категорией.

| ![Atention4](/images/admin-guide/documents/ecbb6d6100a6b04c1847c718353795f8.png) | **Внимание!** Колонка цены с текущей категорией отмечается зеленым маркером.  |
|----------------------------------------------------------|-------------------------------------------------------------------------------|
...
| ![Atention4](/images/admin-guide/documents/ecbb6d6100a6b04c1847c718353795f8.png) | **Внимание!** Добавлена возможность производить расчет цен, используя формулы, заданные в **«параметрах категорий цен»**. Эта возможность позволяет заранее задать стандартные соотношения между разными категориями цен и использовать их для автоматизации расчетов.  |
|----------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
1.  В документе автоматический расчет для одной категории цены может быть вызван из меню кнопки **«Пересчитать»**.
...
| ![Atention4](/images/admin-guide/documents/ecbb6d6100a6b04c1847c718353795f8.png) | **Внимание!** При истечении даты, указанной в поле **«Срок окончания акции»** необходимо создать и провести дополнительный документ **«Переоценка ТМЦ»**, чтобы вернуть цены до акции цены. В противном случае, цены будут акционными и в товарном отчете будут отображаться расхождения остатков на разницу акционной и до акционной цены. |
|----------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

| ![Atention4](/images/admin-guide/documents/ecbb6d6100a6b04c1847c718353795f8.png) | **Внимание!** Можно автоматизировать процесс создания документа **«Переоценка ТМЦ»** после истечения срока действия акции. Подробнее об этом можно узнать из раздела [Автоматическое создание переоценок после окончания акций](#автоматическое-создание-переоценок-после-окончания-акций). |
|----------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

| ![Note4](/images/admin-guide/documents/fc00805c71ddc6ddc2e161712dbd6066.png) | **Примечание!** Изменения продаж в период акции и после нее можно проанализировать в отчете **«Анализ маркетинговых акций»**.  |
|------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------|

### Автоматическое создание переоценок после окончания акций
...
1.  Выбрать наиболее подходящий интервал запуска и указать текст обработки:
...
1.  Запустить программу **ISConfig.exe** и настроить интервал выполнения заданий. Здесь можно указать 1-10 секунд. Этот параметр влияет на частоту проверки наличия заданий для выполнения.
...
| ![Atention4](/images/admin-guide/documents/ecbb6d6100a6b04c1847c718353795f8.png) | **Внимание!** После изменений в службе **ISConfig.exe ОБЯЗАТЕЛЬНО** записать и перезапустить службу.  |
|----------------------------------------------------------|-------------------------------------------------------------------------------------------------------|
...
1.  Зарегистрировать продажу по коду товаров в кассовом ПО, затем закрыть смену в кассовой программе.

...
5.  После заполнения окна регистрации необходимыми позициями, для осуществления расчета с клиентом необходимо вызвать окно **«Расчет с покупателем»**, нажав кнопку **«Подитог»**, либо нажав клавишу «+» в правой части клавиатуры, либо нажав клавиши Ctrl-Enter.

...
При необходимости создания ярлыка запуска на рабочем столе необходимо использовать путь до исполняемого файла javaw.exe из каталога установленной версии **Java Runtime Environment (JRE)** и через параметр "-jar" указать путь до jar файла **ItStart.jar**.

...
Например, для доступа к улице из адреса грузополучателя можно использовать переменную *Файл_Документ_СвСчФакт_ГрузПолуч_Адрес_АдрРФ_Улица.*![](/images/edi/bef02a9e9c9053b38fdafba1a977d5cc.png)
...
|-----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **А**                 | Содержит признак того, был ли погашен сертификат: – желтый – был отправлен ответ на документ; – зеленый – документооборот завершен успешно; – лиловый – был получен отказ; – оранжевый – было получено предложение об аннулировании; – серый – документ аннулирован; – красный – продукция по сертификату была полностью возвращена.  ![](/images/edi/48ba3f2af33c7d24f8c65abe030200b4.png)  |

...
- **Обмен с оборудованием**. Изменен алгоритм выгрузки флагов контроля в 8 поле при обмене с Фронтол 6 и Frontol xPOS3.
	...
	- Флаг 5 (Без ввода количества) - для разливного крепкого алкоголя и разливного пива всегда выгружается значение 0. Для любого маркированного товара кроме разливного пива выгружается значение 1. Для любого разливного немаркированного и неалкогольного товара (например, лимонады), всегда выгружается значение 1. Для всего прочего товара определяется по доп свойству "ФронтолБезВводаКоличества" (если флаг в доп параметре установлен, то выгружается значение 0, иначе - 1).

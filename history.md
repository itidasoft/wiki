...
- **Обмен с оборудованием.** При выгрузке разливного и фасованного пива в программное обеспечение **Frontol 6** и **Frontol xPOS3** признак разливного пива определяется как по алкогольным реквизитам (**Вид продукции**), так и по признакам и типу маркировки (**Маркированный товар** и товарная группа **"Пиво и пивные напитки"**). Признак фасованного или разливного пива определяется по основной единице измерения: единица измерения объема соответствует разливному пиву, остальные единицы - фасованному пиву.

...
-   **Профили оборудования**. Добавлены типы оборудования **Платежная система** и **Прочее оборудование**. Описание новых типов оборудования и принципов работы с ним можно найти в документации на [РМК](https://old.itida.ru/download/docs/mrpv2.pdf)
...
-   **Торговое оборудование**. Добавлены типы оборудования **Платежная система** и **Прочее оборудование**. Описание в документации на [РМК](https://old.itida.ru/download/docs/mrpv2.pdf)
...
Подробное описание новых функций можно найти в документации на [РМК](https://old.itida.ru/download/docs/mrpv2.pdf).
...
-   **Схемы РМК**. В список доступных операций добавлены операции **Аванс** и **Предоплата**. По умолчанию новые операции для чеков запрещены к использованию. Описание новых видов чеков можно найти в документации на [РМК](https://old.itida.ru/download/docs/mrpv2.pdf).
...
-   **Модуль Маркировка.** Выполнен переход на общий механизм аутентификации для обращения к СУЗ. В связи с этим в настройках модуля Маркировка необходимо заполнить новое поле «**ИД соединения**». Подробнее о заполнении этого поля см. [документацию страница 4](https://itida.ru/download/docs/itida_marking202104.pdf).
...
-   **ЕГАИС**. Добавлены шаблоны экспорта деклараций 7 и 8. Для того, чтобы в шаблонах в списке выбора было написано **Форма 8 / Форма 7** необходимо обновить справочник Сервис/Настройка системы/Настройка параметров системы, взяв его с сайта по [ссылке](https://itida.ru/download/profiles/parameters202104.zip). Формирование возможно начиная с версии Айтиды 4.3.1
...
-   **Модуль ЕГАИС.** Добавлена форма проверки расходной накладной перед отправкой в ЕГАИС. Подробнее [см. документацию на модуль ЕГАИС.](https://itida.ru/download/docs/itida_egais202010.pdf)
...
-   **Модуль ЕГАИС.** Добавлена форма вхождения марок в документы. Подробнее [см. документацию на модуль ЕГАИС.](https://itida.ru/download/docs/itida_egais202010.pdf)
...
-   **Модуль МРП 2**. Разработана программа Монитор РМК, предназначенная для анализа работы РМК в режиме реального времени. Программа работает как с локальными РМК, так и с РМК из распределенной сети. Описание новой программы см. [в документации по модулю МРП 2](https://itida.ru/download/docs/mrpv2.pdf).
...
-   **Модуль МРП 2**. В схему РМК добавлены клавиатурные функции:
    ...
    -   Формировать вскрытие тары (операция Прочее).
        ...
        Функции "Формировать документы" позволяют одновременно выбрать тип операции чека и формируемый документ. [Более подробное описание можно найти в документации модуля.](https://itida.ru/download/docs/mrpv2.pdf)
...
-   **Модуль Маркировка**. Документ описания остатков. Убраны колонки ТНВЭД и Способ ввода в оборот. Теперь значения берутся из шапки документа. Подробнее см. [Айтида модуль Маркировка](http://itida.ru/download/docs/itida_marking202003.pdf).
...
-   **Модуль Маркировка**. Добавлена возможность приема КМ и отправки акта подтверждения принятой продукции. Подробнее см. [Айтида модуль Маркировка](http://itida.ru/download/docs/itida_marking202003.pdf).
-   **Модуль Маркировка.** Добавлена возможность отгрузки КМ. Подробнее см. [Айтида модуль Маркировка](http://itida.ru/download/docs/itida_marking202003.pdf).
...
-   **Модуль Маркировка.** Добавлен модуль Маркировка. С документацией по работе с модулем можно ознакомиться по ссылке [Айтида Маркировка](http://itida.ru/download/docs/itida_marking202001.pdf).
...
-   **МРП 2**. Добавлена бонусная система согласно [документации](http://itida.ru/download/docs/mrpv2.pdf) на МРП 2.
...
-   **Документы. Приходная накладная.** В кнопку оборудование добавлен пункт «Сверка с поставщиками алкоголя». Инструкцию по работе с модулем сверки можно посмотреть [здесь](http://www.itida.ru/download/docs/alcovendor_revise.pdf).
...
-   **Модуль ЕГАИС.** Добавлена возможность отправки документов Вскрытие тары. Подробнее см. [Инструкция по работе с модулем ЕГАИС](http://itida.ru/download/docs/itida_egais201612.pdf).
...
-   **Модуль ЕГАИС.** Добавлены константы, позволяющие изменять алгоритм списания продукции по ДКС. Подробнее см. [Инструкция по работе с модулем ЕГАИС](http://itida.ru/download/docs/itida_egais201612.pdf).
...
-   **Работа с ЕГАИС.** Добавлена возможность управлять распределением алкокодов перед отправкой в ЕГАИС акта списания на основании ДКС. Подробнее см. [Инструкция по работе с модулем ЕГАИС](http://itida.ru/download/docs/itida_egais201611.pdf).
...
-   **Работа с ЕГАИС.** В документе Инвентаризация ЕГАИС расширен функционал кнопки **Действия**. Добавлена возможность автоматически сформировать запрос в ЕГАИС для не сопоставленной продукции. Подробнее см. [Инструкция по работе с модулем ЕГАИС](http://itida.ru/download/docs/itida_egais201609.pdf).
-   **Работа с ЕГАИС.** В документ Инвентаризация ЕГАИС добавлена возможность устанавливать/менять связь алко-кодов с товаром. Для этого необходимо в строке документа нажать CTRL-F2 и подобрать новый товар для алко-кода из строки. После подбора товара, система предложить разорвать предыдущую связь, если такая была установлена ранее, и установить новую. Подробнее см. [Инструкция по работе с модулем ЕГАИС](http://itida.ru/download/docs/itida_egais201609.pdf).
-   **Работа с ЕГАИС.** В документ Инвентаризация ЕГАИС добавлена информация о текущем остатке на склада для товара из строки документа. Подробнее см. [Инструкция по работе с модулем ЕГАИС](http://itida.ru/download/docs/itida_egais201609.pdf).
...
-   **Модуль ЕГАИС**. Функционал модуля расширен для работы с версией 2 формата обмена с ЕГАИС, и для возможности работы с двумя регистрами учета ЕГАИС. Подробнее список изменений и доработок см. [Инструкция по работе с модулем ЕГАИС](http://itida.ru/download/docs/itida_egais201609.pdf).
...
-   Модуль ЕГАИС. Добавлена возможность отправки запроса на повтор ТТН (подробнее см. [Инструкция по работе с модулем ЕГАИС](http://itida.ru/download/docs/itida_egais201609.pdf)).
-   В модуль ЕГАИС добавлена возможность отправки запроса отчета по справкам Б (подробнее см. [Инструкция по работе с модулем ЕГАИС](http://itida.ru/download/docs/itida_egais201609.pdf)).
...
-   Добавлена обработка для загрузки данных в 1С бухгалтерию 8.3.43 (обработки и шаблоны экспорта можно скачать со [страницы сайта](http://itida.ru/partners/download/index.php?sid=626&id=7372)).
...
-   Добавлен документ Вскрытие тары. (подробнее см. [Инструкция по работе с документом Вскрытие тары](http://itida.ru/download/docs/itida_egais201609.pdf)).
...
-   Добавлена выгрузка актов списания в ЕГАИС (подробнее см. [Инструкция по работе с модулем ЕГАИС](http://itida.ru/download/docs/itida_egais201609.pdf)) .
-   Добавлен список отправленных в ЕГАИС запросов и полученных на них ответов (подробнее см. [Инструкция по работе с модулем ЕГАИС](http://itida.ru/download/docs/itida_egais201609.pdf)) .
...
-   В форме регистрации продаж добавлена возможность отложить чек, а потом загрузить его, и продолжить с ним работу. Стандартная комбинация клавиш для выполнения команды CTRL-O. Комбинация клавиш может быть переназначена для пользователя.
...
-   В форму проверки наличия на складах (вызывается из справочника ТМЦ по F5) добавлена возможность настройки отображаемой информации. Доступно при наличии NFR лицензии или сублицензии.
...
-   Добавлен модуль для работы с ЕГАИС (подробнее см. Модуль ЕГАИС в Айтиде.pdf).
...
-   В форме регистрации продаж добавлена возможность смены пользователя комбинацией клавиш клавиатуры CTRL-SHIFT+U (можно переназначить).
-   Добавлена возможность изменять размер шрифта в форме регистрации продаж и в окне подбора товара клавишами CTRL-UP и CTRL-DOWN. Выбранный размер сохраняется для текущего пользователя.
...
-   Добавлен отчет по движениям алко-кодов. Подробнее см. [Инструкция по работе с модулем ЕГАИС](http://itida.ru/download/docs/itida_egais201609.pdf).

...
## Версия 4.5.5
### 27.12.2023
- **Модуль Маркировка.** Добавлен тип документа выбытия КМ «**Установка на кран**». Документ предназначен для отправки в ГИС МТ информации об установке кега на кран.

...
В карточке товара для маркированного разливного пива необходимо установить **признак маркироки**, выбрать товарную группу **"Пиво и пивные напитки"** и установить флаг **"Продажа в розлив"**. Так же необходимо выбрать корректный вид продукции, соответствующий пивной продукции.
...
> Для корректной работы с постановкой на кран в программном обеспечении Frontol, необходимо подключить к ПО Frontol наше решение "**Айтида iMark**" или решение от компании Атол "Frontol MarkUnit". В этом случае с помощью указанных сервисов при постановке разливного пива на кран корректный **объем будет получен из ГИС МТ**.
{.is-warning}

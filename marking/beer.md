...
**Внимание!** Для того, чтобы служба имела доступ к сертификатам пользователя, для которого были установлены сертификаты ключей ЭЦП
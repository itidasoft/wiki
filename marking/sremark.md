...
> Процесс получения старых КМ можно автоматизировать, используя специальное задание планировщика. Процесс настройки такого задания указан в [Приложении 1](#приложение-1-задание-планировщика-для-автоматического-получения-старых-км) данного руководства
{.is-success}
